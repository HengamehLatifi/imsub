...
type TwitchAPI interface {
	...
	ListEventSubs(ctx context.Context, appToken string, opts ListEventSubsOpts) ([]EventSubSubscription, error)
	DeleteEventSub(ctx context.Context, appToken, subscriptionID string) error
}
